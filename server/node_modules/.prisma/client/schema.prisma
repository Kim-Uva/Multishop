...
// model tabCat{
//   idCategoria Int
//     categorias         Categoria          @relation(fields: [idCategoria], references: [id]) // Llave foranea


// idSubCategoria Int
//     subCategorias         SubCategoria          @relation(fields: [idSubCategoria], references: [id]) // Llave foranea

//   @@id([idCategoria, idSubCategoria])
...
model Pedido {
  ...
  fechaPedido        DateTime          @default(now()) //Puede ser la fecha de envio
  idEstado           Int
...
model TrasladoBodegas {
  //Pedido que abarca bodega, Usuario, detalles y mas
  idPedido Int
  ...
  @@id([idPedido, idDestino])
}

model TrasladoDestino {
  id              Int               @id @default(autoincrement())
  idBodegaDestino Int //Bodega Destino
  bodegas         Bodega            @relation(fields: [idBodegaDestino], references: [id])
