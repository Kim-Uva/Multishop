...
router.post('/updateInventario', inventarioController.updateInventario) //Llama el metodo put de module.exports del controller
...
router.post('/getInventarioByIdBodegaIdProducto', inventarioController.getInventarioByIdBodegaIdProducto)
